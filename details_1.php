						...
						<ul id="etalage">
							<li>
								<a href="optionallink.php">
									<img class="etalage_thumb_image" src="images/product-slide/5.jpg" />
									<img class="etalage_source_image" src="images/product-slide/5.jpg" />
								</a>
							</li>
							<li>
								<img class="etalage_thumb_image" src="images/product-slide/6.jpg" />
								<img class="etalage_source_image" src="images/product-slide/6.jpg" />
							</li>
							<li>
								<img class="etalage_thumb_image" src="images/product-slide/7.jpg" />
								<img class="etalage_source_image" src="images/product-slide/7.jpg" />
							</li>
							<li>
								<img class="etalage_thumb_image" src="images/product-slide/8.jpg" />
								<img class="etalage_source_image" src="images/product-slide/8.jpg" />
							</li>
						</ul>
					</div>
					<div class="details-left-info">
						<div class="details-right-head">
						<h1>Nike HYPERVENOM Phantom FDG</h1>
						<ul class="pro-rate">
							<li><a class="product-rate" href="#"> <label> </label></a> <span> </span></li>
							<li><a href="#">11 Отзывов</a></li>
						</ul>
						<p class="product-detail-info">Носи летний закат с собой — выбирай кроссовки Nike HYPERVENOM Phantom FDG.</p>
