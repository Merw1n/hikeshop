						...
						<ul id="etalage">
							<li>
								<a href="optionallink.php">
									<img class="etalage_thumb_image" src="images/product-slide/9.jpg" />
									<img class="etalage_source_image" src="images/product-slide/9.jpg" />
								</a>
							</li>
							<li>
								<img class="etalage_thumb_image" src="images/product-slide/10.jpg" />
								<img class="etalage_source_image" src="images/product-slide/10.jpg" />
							</li>
							<li>
								<img class="etalage_thumb_image" src="images/product-slide/11.jpg" />
								<img class="etalage_source_image" src="images/product-slide/11.jpg" />
							</li>
							<li>
								<img class="etalage_thumb_image" src="images/product-slide/12.jpg" />
								<img class="etalage_source_image" src="images/product-slide/12.jpg" />
							</li>
						</ul>
					</div>
