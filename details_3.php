						...
						<ul id="etalage">
							<li>
								<a href="optionallink.php">
									<img class="etalage_thumb_image" src="images/product-slide/2.jpg" />
									<img class="etalage_source_image" src="images/product-slide/2.jpg" />
								</a>
							</li>
							<li>
								<img class="etalage_thumb_image" src="images/product-slide/1.jpg" />
								<img class="etalage_source_image" src="images/product-slide/1.jpg" />
							</li>
							<li>
								<img class="etalage_thumb_image" src="images/product-slide/3.jpg" />
								<img class="etalage_source_image" src="images/product-slide/3.jpg" />
							</li>
							<li>
								<img class="etalage_thumb_image" src="images/product-slide/4.jpg" />
								<img class="etalage_source_image" src="images/product-slide/4.jpg" />
							</li>
						</ul>
					</div>
					<div class="details-left-info">
						<div class="details-right-head">
						<h1>Nike HYPERVENOM Phantom SUPER</h1>
						<ul class="pro-rate">
							<li><a class="product-rate" href="#"> <label> </label></a> <span> </span></li>
							<li><a href="#">11 Отзывов</a></li>
						</ul>
						<p class="product-detail-info">Носи летний закат с собой — выбирай кроссовки Nike HYPERVENOM Phantom SUPER.</p>
