						...
						<ul id="etalage">
							<li>
								<a href="optionallink.php">
									<img class="etalage_thumb_image" src="images/product-slide/13.jpg" />
									<img class="etalage_source_image" src="images/product-slide/13.jpg" />
								</a>
							</li>
							<li>
								<img class="etalage_thumb_image" src="images/product-slide/14.jpg" />
								<img class="etalage_source_image" src="images/product-slide/14.jpg" />
							</li>
							<li>
								<img class="etalage_thumb_image" src="images/product-slide/15.jpg" />
								<img class="etalage_source_image" src="images/product-slide/15.jpg" />
							</li>
							<li>
								<img class="etalage_thumb_image" src="images/product-slide/16.jpg" />
								<img class="etalage_source_image" src="images/product-slide/16.jpg" />
							</li>
						</ul>
					</div>
					<div class="details-left-info">
						<div class="details-right-head">
						<h1>Nike HYPERVENOM Phantom FUSG</h1>
						<ul class="pro-rate">
							<li><a class="product-rate" href="#"> <label> </label></a> <span> </span></li>
							<li><a href="#">11 Отзывов</a></li>
						</ul>
						<p class="product-detail-info">Носи летний закат с собой — выбирай кроссовки Nike HYPERVENOM Phantom FUSG.</p>
