						...
						<ul id="etalage">
							<li>
								<a href="optionallink.php">
									<img class="etalage_thumb_image" src="images/product-slide/29.jpg" />
									<img class="etalage_source_image" src="images/product-slide/29.jpg" />
								</a>
							</li>
							<li>
								<img class="etalage_thumb_image" src="images/product-slide/30.jpg" />
								<img class="etalage_source_image" src="images/product-slide/30.jpg" />
							</li>
							<li>
								<img class="etalage_thumb_image" src="images/product-slide/31.jpg" />
								<img class="etalage_source_image" src="images/product-slide/31.jpg" />
							</li>
							<li>
								<img class="etalage_thumb_image" src="images/product-slide/32.jpg" />
								<img class="etalage_source_image" src="images/product-slide/32.jpg" />
							</li>
						</ul>
					</div>
					<div class="details-left-info">
						<div class="details-right-head">
						<h1>Nike HYPERVENOM Phantom FG</h1>
						<ul class="pro-rate">
							<li><a class="product-rate" href="#"> <label> </label></a> <span> </span></li>
							<li><a href="#">11 Отзывов</a></li>
						</ul>
						<p class="product-detail-info">Носи летний закат с собой — выбирай кроссовки Nike HYPERVENOM Phantom FG.</p>
